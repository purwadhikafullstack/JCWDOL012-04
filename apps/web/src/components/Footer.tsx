...
export const Footer = (
  ...
  return (
    <main className="flex pt-4 w-full items-center justify-center border-t-2">
      <div className="flex flex-col gap-7 justify-between w-full px-6 py-6 md:flex-row md:max-w-[1028px]	">
